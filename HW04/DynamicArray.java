...
public class DynamicArray<T extends Number> {
    ...
    /**
     * 8.Принимает на вход элемент и возвращает его индекс в массиве.
    ...
    /**
     * 9.Принимает на вход элемент и возвращает true, если элемент
    ...
    /**
     * 13. Получение элемента по индексу
     * 
     * @param index
     * @return
     */
